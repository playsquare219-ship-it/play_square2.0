...
export async function GET() {
  try {
    ...
    // Keep the full match list available for client-side filtering.
    // This allows the My Matches tab to show matches created by the current user
    // and matches involving the user's team, instead of returning only one team's data.
    if (token) {
